...
public class GalleryImageView extends ImageView {
    private static final String TAG = "com.zhaoxin.zxcamera.gallery.GalleryImageView";
    ...
    int mThisWidth = -1, mThisHeight = -1;//layout width and height

    float mMaxZoom;// max scale
    float mMinZoom;// min scale

    private int imageWidth;// picture origin width
    private int imageHeight;// picture origin height

    // float scaleRate;// auto adaptive scale
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mImage != null) {
            getProperBaseMatrix(mImage, mBaseMatrix);
            setImageMatrix(getImageViewMatrix());
        }
    }
    ...
    protected void zoomTo(float scale, float centerX, float centerY) {
        ...
        Log.d(TAG, "[GalleryImageView.zoomTo]" + "scale=" + scale + ",mMaxZoom=" + mMaxZoom + ",mMinZoom=" + mMinZoom);
